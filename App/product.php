		...
		<div class="container">
			...
			<div class="row isotope-grid">
				...
				<?php 
					...
					$produtos = new \App\Model\produtoDao();
					$listaprodutos = $produtos->read();


					foreach($listaprodutos as $produto):

						echo '<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item men">';
						echo '<div class="block2">';
						echo '<div class="block2-pic hov-img0">';
						echo '<img src="images/product-03.jpg" alt="IMG-PRODUCT">';
						...
						echo '</a> <span class="stext-105 cl3">';
